...
case class MSearchResponse(ts: Int,
                           ...
                           tags: List[String],
                           opens: Int,
                           opens_detail: Option[List[MOpenDetail]],
                           clicks: Int,
                           clicks_detail: Option[List[MClickDetails]],
                           state: String)
...
/**
  ...
  */
case class MTimeSeriesResponse(time: DateTime,
                               sent: Int,
                               hard_bounces: Int,
                               soft_bounces: Int,
                               rejects: Int,
...
/**
  ...
  * @param send_at    - when the message will be sent
